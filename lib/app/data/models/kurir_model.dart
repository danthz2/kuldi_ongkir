class KurirModel {
  ...
  KurirModel({this.code, this.name, this.costs});
  ...
  static List<KurirModel> fromJsonList(List list) {
    if (list.isEmpty) return List<KurirModel>.empty();
    return list.map((item) => KurirModel.fromJson(item)).toList();
  }
}
